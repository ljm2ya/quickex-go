...
func (c *BybitFuturesClient) SetLeverage(ctx context.Context, symbol string, leverage int) error {
...
func (c *BybitFuturesClient) GetLiquidationPrice(ctx context.Context, symbol string) (decimal.Decimal, error) {
...
func (c *BybitFuturesClient) GetFundingRate(ctx context.Context, symbol string) (*core.FundingRate, error) {
...
func (c *BybitFuturesClient) SetMarginMode(ctx context.Context, mode core.MarginMode) error {
